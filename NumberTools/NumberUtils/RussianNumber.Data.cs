...
{
    public partial class RussianNumber
    {
        /// <summary>
        ...
        /// </summary>
#if USE_QUADRILLIONS
        private const int MAX_TOKEN_LENGTH = 13;
#else
        ...
        private static readonly Dictionary<string, Numeral> TOKENS = new Dictionary<string, Numeral>
        {
...
#endif
#if USE_QUADRILLIONS
            { "квадриллион",   new Numeral(1000000000000000, 8, true  ) },
            { "квадриллиона",  new Numeral(1000000000000000, 8, true  ) },
            { "квадриллионов", new Numeral(1000000000000000, 8, true  ) },
#endif
#if USE_SLANG_WORDS
            ...
            { "дюжина",        new Numeral(12,      1, true  ) },
            { "дюжины",        new Numeral(12,      1, true  ) },
            { "дюжин",         new Numeral(12,      1, true  ) },
            ...
            { "лям",           new Numeral(1000000, 5, true  ) },
            { "ляма",          new Numeral(1000000, 5, true  ) },
            { "лямов",         new Numeral(1000000, 5, true  ) },
